  ...
  return (
    ...
    <Clientdata></Clientdata>
      <div name='addclient'>
        ...
        <input type='number' name='height' placeholder='Enter Height(inches)' onChange={e => setheight(e.target.value)} id='clientheight' />
        <label htmlFor="clientlastname">Weight:</label>
        <input type='number' name='weight' placeholder='Enter Weight(lbs)' onChange={e => setweight(e.target.value)} id='clientweight' />
        <br></br>
