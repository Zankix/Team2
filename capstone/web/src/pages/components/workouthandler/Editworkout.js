...
const EditWorkout = () => {
  ...
  const handleSave = async () => {
    try {
      ...
      const index = updatedWorkouts.findIndex((w) => w.id === selectedWorkout.id);
      updatedWorkouts[index] = selectedWorkout;
      await pb.collection('workouts').update(selectedWorkout.id, selectedWorkout);
